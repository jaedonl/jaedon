        ...
        "saturday-skin": [
            ...
            },
            {
                projects: [
                    ...
                    {
                        id: 3,
                        img: "/assets/projects/ss3.png",
                        title: "Saturday Skin",
                        info: "Shopify Ecommerce Store",
                        part: "News article page",                
                    },
                    {
                        id: 4,
                        img: "/assets/projects/ss4.png",
                        title: "Saturday Skin",
                        info: "Shopify Ecommerce Store",
        ...
        "cmyk+white": [
            ...
            },
            {
                projects: [
                    ...
                    {
                        id: 3,
                        img: "/assets/projects/cmyk3.png",
                        title: "CMYK + White",
                        info: "Desogm Agency",
                        part: "Client detail page",                 
                    },
                    {
                        id: 4,
                        img: "/assets/projects/cmyk4.png",
                        title: "CMYK + White",
                        info: "Desogm Agency",
                        part: "CMYK timeline horizontal scroll",                    
                    },
                ],
            }
        ]
        ...
        "chalogy-beauty": [
            ...
            },
            {
                projects: [
                    ...
                    {
                        id: 2,
                        img: "/assets/projects/cha2.png",
                        title: "Chalogy Beauty",
                        info: "Cosmetic Lab",
                        part: "Full screen scroll",                  
                    },
                    {
                        id: 3,
                        img: "/assets/projects/cha3.png",
                        title: "Chalogy Beauty",
                        info: "Cosmetic Lab",
                        part: "About Chalogy Beauty",                  
                    },
                    {
                        id: 4,
                        img: "/assets/projects/cha4.png",
                        title: "Chalogy Beauty",
                        info: "Cosmetic Lab",
                        part: "Brand Chalogy Beauty",                  
                    },
                ],
            }
        ]
        ...
        "admin-page": [
            ...
            },
            {
                projects: [
                    {
                        id: 1,
                        img: "/assets/projects/admin1.png",
                        title: "Simple Admin Page",
                        info: "Admin page for store (React.js)",
                        part: "Admin main page",                  
                    },
                    {
                        id: 2,
                        img: "/assets/projects/admin2.png",
                        title: "Simple Admin Page",
                        info: "Admin page for store (React.js)",
                        part: "Product list page",                  
                    },
                    {
                        id: 3,
                        img: "/assets/projects/admin3.png",
                        title: "Simple Admin Page",
                        info: "Admin page for store (React.js)",
                        part: "Product upload page",                  
                    },
                    {
                        id: 4,
                        img: "/assets/projects/admin4.png",
                        title: "Simple Admin Page",
                        info: "Admin page for store (React.js)",
                        part: "Edit user page",                  
                    },
